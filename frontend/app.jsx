...
const BOTS = {
  rules: {
    id: "rules",
    name: "سکوبات قوانین",
    sub: "دستیار آیین‌نامه‌های پارک علم و فناوری گیلان",
    glyph: "⚖️",
    blurb: " سؤال‌های خود را درباره‌ی شرایط پذیرش، مدت استقرار، تسهیلات و آیین‌نامه‌های داخلی مرکز رشد گیلان از این دستیار بپرسید.",
    examples: [
  ...
  resume: {
    id: "resume",
    name: "سکوبات رزومه",
    sub: "دستیار جست‌وجو در رزومه‌ی اعضای سکو",
    glyph: "📄",
